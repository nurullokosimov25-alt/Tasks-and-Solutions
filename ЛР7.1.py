#Команда Sliding Window-задача  7 стабильность значений Требования (обязательные) sliding.py 
#• 1 функция • проверка некорректных входных данных test_sliding.py • минимум 3 unit-теста • 1 тест на ошибку 
#Рефакторинг • осмысленные имена • упрощённые выражения • отсутствие дублирования README.md • описание алгоритма • как запускать тесты 
#(sliding.py)
#(sliding.py)
